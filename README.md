...
- 能够持续阅读 30 分钟以上并且不分心的专注力。
  ...
  许多读者反映较长的句子阅读起来非常困难，有关这一点，笔者会尽可能在文中再做改进，但是基本的**阅读长文本**的能力仍然很重要。本书不是绘本，文字占比居多是必然的，对于零基础的读者，要解释清楚内容也需要不短的篇幅。请不要跳读，也不要急于求成 —— 那样会非常容易漏过重要的步骤。
...
- 一个流畅的网络连接
  ...
  此处所说的“流畅”并非指下载速度或延迟，而是指**能正常打开大多数网站**，例如 [Paper 官方网站](https://papermc.io) 和 [Spigot 官方网站](https://hub.spigotmc.org)。本书会考虑到读者的网络情况并提供相应的建议，但如果你的网络很通畅，事情就能方便很多。
...
!> 为促进讨论区的正确使用，本书的讨论区内容**严格地限制于本书的教学范围内**。任何与 Minecraft 插件开发无关的内容，或者相关性很低的内容，都是**严格禁止**的。此外，即使与 Minecraft 插件开发相关，包含广告、政治、宗教、引战或其它不当内容的讨论也是**绝不被允许的**。
